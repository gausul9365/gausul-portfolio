...
const SocialLinks = () => {
  return (
    <div className="mt-8 flex gap-2 font-bold opacity-60">
      <Link
        target="_blank"
      ...
      <Link
        ...
        data-state="closed"
        data-slot="tooltip-trigger"
        href="https://www.linkedin.com/in/gausul-wara-643783256/"
      >
        <span className="size-6">
          <svg
            xmlns="http://www.w3.org/2000/svg"
      ...
      <Link
        ...
        data-state="closed"
        data-slot="tooltip-trigger"
        href="https://github.com/gausul9365"
      >
        <span className="size-6">
          <svg
            xmlns="http://www.w3.org/2000/svg"
      ...
      <Link
        ...
        data-state="closed"
        data-slot="tooltip-trigger"
        href="https://www.instagram.com/gausul/"
      >
        <span className="size-6">
          <svg
            xmlns="http://www.w3.org/2000/svg"
      ...
      <Link
        ...
        data-state="closed"
        data-slot="tooltip-trigger"
        href="https://in.pinterest.com/gausulwarapinterest/"
      >
        <span className="size-6">
          <svg
            xmlns="http://www.w3.org/2000/svg"
