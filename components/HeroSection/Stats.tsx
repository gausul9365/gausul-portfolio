...
export const Stats = async () => {
  try {
    ...
    const res = await axios.post(
      ...
      {
        query: `query { user(login: "gausul9365") { contributionsCollection { totalCommitContributions } } }`,
      },
      {
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            ...
            <span className={`text-sm font-medium`}>Learning New stuffs and placements</span>
          </div>
        </div>
